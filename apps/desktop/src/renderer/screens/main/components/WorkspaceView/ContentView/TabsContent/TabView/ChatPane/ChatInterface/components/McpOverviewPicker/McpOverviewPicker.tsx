							...
							>
								...
								<div className="ml-3 flex shrink-0 items-center gap-1.5">
									{server.connected === true ? (
										...
										<span className="rounded-full border border-zinc-500/30 bg-zinc-500/10 px-2 py-0.5 text-xs font-medium text-zinc-700 dark:text-zinc-300">
											Disconnected
										</span>
									) : null}
									...
									<span
										className={`rounded-full border px-2 py-0.5 text-xs font-medium ${getStateClassName(server.state)}`}
									>
