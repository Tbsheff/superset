...
export function WorkspaceDiffStats({
	...
	return (
		<div
			className={cn(
				"flex h-5 shrink-0 items-center rounded px-1.5 text-xs font-mono tabular-nums transition-[opacity,visibility] group-hover:opacity-0 group-hover:invisible",
