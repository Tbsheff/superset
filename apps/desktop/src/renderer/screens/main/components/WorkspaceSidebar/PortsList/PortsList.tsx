...
export function PortsList() {
	...
	return (
		<div className="pt-3 border-t border-border">
			<div className="group text-xs uppercase tracking-wider text-muted-foreground/70 px-3 pb-2 font-medium flex items-center gap-1.5 w-full hover:text-muted-foreground transition-colors">
				<button
					type="button"
				...
				<span className="text-xs font-normal">{totalPortCount}</span>
			</div>
			{!isCollapsed && (
