...
export function getDiffViewerStyle(
	...
	return {
		...
		"--diffs-bg-addition-emphasis-override": "color-mix(in lab, var(--background, #151110) 65%, #00a240)",
		"--diffs-bg-deletion-emphasis-override": "color-mix(in lab, var(--background, #151110) 65%, #d4614a)",
