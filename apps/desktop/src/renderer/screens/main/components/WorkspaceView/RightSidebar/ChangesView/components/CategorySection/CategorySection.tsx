	...
	return (
		...
		>
			...
			>
				<CollapsibleTrigger
					className={cn(
						"flex-1 flex items-center gap-2 px-2 py-1.5 text-left min-w-0 rounded-md",
				...
				>
					...
					<span className="text-[10px] text-muted-foreground shrink-0 bg-muted-foreground/10 rounded-full px-1.5 py-0.5">
						{count}
					</span>
				</CollapsibleTrigger>
